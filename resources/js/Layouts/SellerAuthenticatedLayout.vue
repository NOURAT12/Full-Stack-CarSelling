...
<template>
  <div>
    ...
    <div class="min-h-screen bg-gray-100">
      <div v-if="$page.props.auth.user.Role=='seller'">
        <nav
            ...
            <div class="flex justify-between h-16">
              <div class="flex">
                ...
                <div class="shrink-0 flex items-center" v-if="settings">
                  <Link :href="route('sellerdashboard')">
                ...
                <!-- Navigation Links -->
                <div
                  class="hidden space-x-8 rtl:space-x-reverse sm:-my-px sm:ms-10 sm:flex"
                >
                  <NavLink
                    :href="route('sellerdashboard')"
                    :active="route().current('sellerdashboard')"
                  >
                  ...
                  <NavLink
                    :href="route('reviewsIndex')"
                    :active="route().current('reviewsIndex')"
                  >
